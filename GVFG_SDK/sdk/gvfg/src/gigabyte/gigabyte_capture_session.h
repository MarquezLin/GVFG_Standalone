...
namespace gvfg::internal
{
    ...
    public:
        ...
        gvfg_status_t get_signal_status(gvfg_signal_status_t &out);
        void get_cached_signal_status(gvfg_signal_status_t &out) const;
        gvfg_status_t get_device_capabilities(gvfg_device_capabilities_t &out);
        gvfg_status_t get_sdi_info(gvfg_sdi_info_t &out);
        gvfg_status_t get_audio_format(GigabyteAudioInfo &out);
    ...
    private:
        ...
        gvfg_status_t ensure_vendor_channel_open();
        void close_vendor_channel();
        ...
        PGVFG_CONTEXT context_ = nullptr;
        GVFG_VIDEO_CHN_EVENT events_{};
        HANDLE stop_event_ = nullptr;
        HANDLE recovery_event_ = nullptr;
