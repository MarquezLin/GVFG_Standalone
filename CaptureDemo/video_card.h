...
#define PCIES2MM_EVENT_TYPE_VIDEO_MODULE 1
#define PCIES2MM_EVENT_TYPE_AUDIO_DMA    2
typedef struct _PCIES2MM_EVENT_REG
{
    ULONG Type;          // Event type: 0=VideoDma, 1=VideoModule, 2=AudioDma
...
public:
     ...
     */
    int startCapture(ULONG channelIndex, int width, int height, const std::function<void(uchar *, int, int)> &cb);
